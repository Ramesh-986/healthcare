  ...
  <main>
    <div class="doctor-profile">
     <img src="https://www.pngitem.com/pimgs/m/194-1943739_indian-doctor-hd-png-download.png" height="200">
      ...
      <ul>
        <li><span>Education:</span>  Harvard Medical School</li>
        <li><span>Residency:</span> Johns Hopkins Clinic</li>
        <li><span>Board Certification:</span> American Board of Internal Medicine - Neurology</li>
        <li><span>Experience:</span> 19 years</li>
        <li><span>Phone:</span> 0828822462</li>
        <li><span>Email:</span> David.r@mrhealthcare.com</li>
      </ul>
    </div>
  </main>
</body>
