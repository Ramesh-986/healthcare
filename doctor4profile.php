...
<body>
  ...
  <main>
    ...
    <!-- "https://thumbs.dreamstime.com/z/smiling-medical-doctor-23239260.jpg"width="100" height="200"> -->
      ...
      <ul>
        <li><span>Education:</span>University of California</li>
        <li><span>Residency:</span> sarah Clinic</li>
        <li><span>Board Certification:</span> california Board of Medicine - Dermatologist</li>
        <li><span>Experience:</span> 22 years</li>
        <li><span>Phone:</span> 0855522400</li>
        <li><span>Email:</span> sarah.Lee@mrhealthcare.com</li>
      </ul>
    </div>
  </main>
</body>
