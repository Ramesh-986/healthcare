...
<body>
  ...
  <main>
    <div class="doctor-profile">
      ...
      <ul>
        <li><span>Education:</span>University of Texas Southwestern Medical School</li>
        <li><span>Residency:</span> Maria Clinic</li>
        <li><span>Board Certification:</span> Texas Board of Medicine - Obstetrics & Gynecology</li>
        <li><span>Experience:</span> 15 years</li>
        <li><span>Phone:</span> 0825522992</li>
        <li><span>Email:</span> maria.r@mrhealthcare.com</li>
      </ul>
    </div>
  </main>
</body>
